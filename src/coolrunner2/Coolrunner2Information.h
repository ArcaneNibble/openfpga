...
#ifndef Coolrunner2Information_h
#define Coolrunner2Information_h

// Giant table of constants
...
const char * const COOLRUNNER2_PART_NAMES[COOLRUNNER2_PART_COUNT] = {
    "XC2C32",
    "XC2C32A",
    "XC2C64",
    "XC2C64A",
...
const char * const COOLRUNNER2_PKG_NAMES[COOLRUNNER2_PKG_COUNT] = {
    "QFG32",
    "VQ44",
    "QFG48",
    "CP56",
...
const char * const COOLRUNNER2_SPEED_NAMES[COOLRUNNER2_SPEED_COUNT] = {
    "3",
    "4",
    "5",
    "6",
...
bool const COOLRUNNER2_VALID_COMBINATIONS[COOLRUNNER2_PART_COUNT][COOLRUNNER2_PKG_COUNT][COOLRUNNER2_SPEED_COUNT] =
{
    // XC2C32
    {
        // QFG32
...
int const COOLRUNNER2_ZIA_INPUTS[COOLRUNNER2_PART_COUNT] = {
    65,
    65,
    128,
    128,
