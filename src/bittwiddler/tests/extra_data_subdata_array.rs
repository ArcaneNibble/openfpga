...
#[derive(Debug, PartialEq, Eq)]
struct MyStruct2 {
    #[encode_sub_extra_data((extra_data as u8) + (arr_elem_i as u8))]
    #[decode_sub_extra_data((extra_data as u16) + (arr_elem_i as u16))]
    #[arr_off(|_| [0])]
    inner: [MyStruct1; 1],
}

#[test]
fn extra_data_subdata_array_encode() {
...
#[test]
fn extra_data_subdata_array_decode() {
    let x = [true,
        false, false,
        true, false,
        false, true,
