...
fn extra_data_decode() {
    let x = [true,
        ...
        true, false,
        false, true];
    let out = MyStruct1::decode(&x[..], [0], [false], 2).unwrap();
    ...
    let x = [
        ...
        false, false,
        true];
    let out = MyStruct1::decode(&x[..], [12], [true], 2).unwrap();
    assert_eq!(out, MyStruct1 {
        field_enum: [
            [[MyEnum::Choice1, MyEnum::Choice3]],
            [[MyEnum::Choice2, MyEnum::Choice4]],
